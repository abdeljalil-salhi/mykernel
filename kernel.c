...
uint8_t		terminal_color_default = VGA_COLOR_LIGHT_GREY;
uint8_t		terminal_background_default = VGA_COLOR_BLACK;

void terminal_initialize(void)
{
	terminal_row = 0;
	terminal_column = 0;
	terminal_color = vga_entry_color(terminal_color_default, terminal_background_default);
